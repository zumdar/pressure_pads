...
//
const int controllerA3 = 20; // 10 = pan position
const int controllerA4 = 21; // 11 = volume/expression
const int controllerA5 = 22; // 11 = volume/expression
const int controllerA8 = 23; // 11 = volume/expression
const int controllerA9 = 24; // 11 = volume/expression
